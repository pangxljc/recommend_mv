...
<div id="wrapper" class="col-md-12" style="margin-left: 4%;width: 1736px" >
    <div id="content">
        <h1 style="margin-top: 50px">选电影</h1>
        <div class="grid-16-8 clearfix">

            <!-- 左侧电影展示模块-->

            <div  class="article" style="width: 1300px;">
                <div class="gaia">
                    ...
                    <div   class="list-wp"  style="width: 100%;">
                        <div id="list" class="list"  style="width: 1300px;">
